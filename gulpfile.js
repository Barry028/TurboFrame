...
// 編譯 babelEs5Js ES6 轉 5 
function babelEs5Js() {
    return src([
            "src/javascript/turboframes_justJavascript/*.js",
        ], {
            "allowEmpty": true
        })
        .pipe(concat("turboframe_JsUtils_justJavascript_bundle.min.js"))
